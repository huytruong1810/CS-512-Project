...
VAE_Encoder_path = "model/S_VAE_Encoder.pt"
VAE_G_path = "model/S_VAE_G.pt"
VAE_C_path = "model/S_VAE_C.pt"

VAE_Encoder_optim_path = "model/S_optimVAE_Encoder.pt"
VAE_G_optim_path = "model/S_optimVAE_G.pt"
VAE_C_optim_path = "model/S_optimVAE_C.pt"
...
log_image_freq = 100  # How frequent to log images
...
save_rate = 100  # save model after each training epoch
